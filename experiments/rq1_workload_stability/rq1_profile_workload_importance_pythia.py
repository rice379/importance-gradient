#!/usr/bin/env python3
"""
RQ1 workload-stability profiler for ImportanceGradient on Pythia-1.4B.
...
def topk_squared_norms_for_fused_qkv(
    ...
    Pythia/GPT-NeoX stores Q, K, and V in one query_key_value parameter. This
...
def parse_args():
    ...
    # model / data
    p.add_argument("--model_name_or_path", type=str, default="EleutherAI/pythia-1.4b")
